...
return (
  <div className="signup" style={{height:"410vh",width:"100vw"}}>
  <Header />
...
*/}
      <div className="form-container" style={{height:"200vh"}}>
        ...
        <form action="https://blcdjd0s-5000.inc1.devtunnels.ms/create-user" method="POST" className="stuForm"
        ...
        >
          ...
          <div className="form-div " style={{width:"42vw"}}>
            ...
            <input
              className="form-input" style={{width:"33vw"}}
              type="email"
              name="email"
              id="email"
              required
          ...
          <div className="form-div " style={{width:"42vw"}}>
            ...
            <input
              className="form-input" style={{width:"33vw"}} type="date" name="dob" id="dob" onChange={handleChange} />
          </div>
          <div className="form-div " style={{width:"42vw"}}>
            <label
              htmlFor="fatherName"
          ...
          <div className="form-div "style={{ width: "42vw", height: "11vh", marginTop: "9px", fontWeight: "bold" }}>
          ...
          <div className="form-div " style={{width:"42vw"}}>
            <input
              className="form-input bg-sky-300/95 hover:bg-sky-600/100 text-white" style={{width:"20vw", marginLeft:"95px"}}
              type="submit"
              value="submit"
