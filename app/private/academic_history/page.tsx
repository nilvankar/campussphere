...
const AcademicsHistoryModule = () => {
  return (
    <div>
      <Link className="text-black" style={{textDecoration:"none"}} href="/private/academic_history/history">
        <Image src="/images/academic_history.jpeg" alt="Academic History" width={200} height={200} />
        Academic History</Link>
      <Link className="text-black" style={{textDecoration:"none"}} href="/private/academic_history/no_exam_mgmt">
