...
const Header = () => {
  return (
    <div className='bg-slate-300/95 w-screen h-24 flex items-center'>
      {/* Apply styles directly to the Image component */}
      <div className='size-16 relative' style={{ width: '100px', height: '100px' }}>
        <Image src='/images/campusshere_logo.png' height={200} width={200} className='rounded-full' alt='campussphere' />
      </div>
